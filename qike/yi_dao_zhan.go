...
func YiDaoZhan(yg uint,eg uint,sg uint,ri uint)  {
	...
	/*
		yi_dao_zhan := GongWEi{
			DaAn:"大安五行为木数为1 7金灾之命\n最克夫 忌父寅午戌属相人 父有车关，" +
				"\n自身流年忌羊猴牛日 占大安得妻福压祸，见空亡反克妻，妻身体不好心脏病或肝胆有病，\n" +
				"岳父娶二妻或独守岳家，男丁孤单多个必有早走之人，\n" +
				"十落大安兄弟两多一个婚必败，兄弟无义不相合，学堂必有挫折 有技术压身，借妻之福 应寅申巳亥，\n" +
				"大安最忌合伙经商，三落大安脾气急躁 遇事不稳肝火旺，脊柱脑神经病，头脚带伤，上葬亡命格 不须劳碌财顺可得，\n" +
				"一生孤单 不免刑克 自身多见伤灾，取弟不多扎根不会过两名，\n" +
				"压兄运不见抬 互换运可发家，早婚必离。\n" +
				"二落大安离乡发展 双二落 依母亲 性格刚烈必见孤单，\n" +
				"克父缘薄 克自身体弱，车关占命一落克父母，\n" +
				"婚不白头 克兄弟运气，克子女婚姻 见破坟地必是低坟，寻高岗青年灾多，\n" +
				"刑克不顺腿脚带伤，五落大安妻家姐妹少两个，正位三个 克岳母身体不好，\n" +
				"五落大安灾命最凶，中年克妻在异途 若寅相来相合妻花当年必入土。\n",
			LiuLian:"",
			SuXi:"",
			ChiKou:"",
			XiaoJi:"",
